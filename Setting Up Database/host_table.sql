...
/* Delete copied columns from Listings, except from host_id */
...
/* Add foreign key to Host */
ALTER TABLE Listings 
ADD CONSTRAINT host_id_fk FOREIGN KEY (host_id) REFERENCES Host (id);